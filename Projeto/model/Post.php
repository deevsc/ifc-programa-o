...
class Post
{
	...
	public function read($id_categoria=null) {
		...
		$query = "SELECT id, titulo, texto, id_categoria, autor, dt_criacao FROM 
				 post WHERE id=:id ORDER BY titulo";
		//prepara a execucao 
	...
	public function create() {
		try {
			$query = "INSERT INTO post (titulo, texto, id_categoria, autor, dt_criacao) 
			values (:titulo, :texto, :id_categoria, :autor, :dt_criacao)";
			//prepara a execucao
			$stmt = $this->conexao->prepare($query);
